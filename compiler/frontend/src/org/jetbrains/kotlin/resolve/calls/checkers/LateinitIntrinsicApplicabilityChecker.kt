...
object LateinitIntrinsicApplicabilityChecker : CallChecker {
    ...
    override fun check(resolvedCall: ResolvedCall<*>, reportOn: PsiElement, context: CallCheckerContext) {
        ...
        if (expression !is KtCallableReferenceExpression) {
            ...
            else if (!isBackingFieldAccessible(referencedProperty, propertyReferenceResolvedCall, context)) {
    ...
    private fun isBackingFieldAccessible(
            descriptor: PropertyDescriptor, resolvedCall: ResolvedCall<*>, context: CallCheckerContext
    ): Boolean {
        ...
        val dispatchReceiver = resolvedCall.dispatchReceiver ?: return false
